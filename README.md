...
4.  Legal Issues Involving AI
5.  A Few Things That Litigators Should Know About AI
6.  A Few Things That Transactional Attorneys Should Know About AI
...
Defining artificial intelligence in a single term is extremely difficult, and for some commentators, considered unwise.  *See, e.g.*, Theodore F. Claypoole, "[AI Classifications for Law and Regulation](https://www.womblebonddickinson.com/us/insights/blogs/ai-classifications-law-and-regulation)", Business Law Today (September 15, 2023).  In fact, there is no one single (adequate) definition of artificial intelligence.  Fortunately, there is a "classic" formulation of AI in the categorization of thinking and acting, as illustrated in the following set of quotes, courtesy of AI pioneers Stuart Russell and Peter Norvig in their book "[Artificial Intelligence: A Modern Approach](https://people.eecs.berkeley.edu/~russell/aima/)" (4th ed., 2023):
...
- Gary Marcus, "[Two models of AI oversight - and how things could go deeply wrong](https://garymarcus.substack.com/p/two-models-of-ai-oversight-and-how), [The Road to AI We Can Trust](https://garymarcus.substack.com/) Blog (June 8, 2023).  (Discusses two disparate ways that governments are addressing the AI governance issue.  For him, the "positive future" is one where a global AI agency is formed, and AI is thoroughly regulated.  The "bleak future" is one where there is no agreed-upon reglation and, in the unregulated future, small numbers of "quickly become far more powerful that states..." that ultimately leads to "[a]narchy.")
- [Ethics and Governance of AI](https://cyber.harvard.edu/topics/ethics-and-governance-ai), Berkman Klein Center for Intenet & Society at Harvard University.
